...
ALTER TABLE `#__sppagebuilder` CHANGE `created_time` `created_on` DATETIME NOT NULL;
ALTER TABLE `#__sppagebuilder` CHANGE `created_user_id` `created_by` bigint(20) NOT NULL DEFAULT '0';
ALTER TABLE `#__sppagebuilder` CHANGE `modified_time` `modified` DATETIME NOT NULL;
...
ALTER TABLE `#__sppagebuilder` ADD `checked_out_time` datetime DEFAULT NULL AFTER `checked_out`;
